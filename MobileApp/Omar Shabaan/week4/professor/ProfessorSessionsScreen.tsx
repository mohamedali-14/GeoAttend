...
interface Props {
    ...
    errors?: { course?: string; startTime?: string; endTime?: string; room?: string };
}
            ...
            <View style={styles.modalOverlay}>
                <View style={styles.modalSheet}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <TextInput style={[styles.fieldInput, errors.startTime && styles.fieldInputError]}
                        ...
                        <TextInput style={[styles.fieldInput, errors.endTime && styles.fieldInputError]}
                        ...
                        <TextInput style={[styles.fieldInput, errors.room && styles.fieldInputError]}
