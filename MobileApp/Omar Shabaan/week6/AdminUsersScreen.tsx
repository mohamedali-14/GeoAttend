        ...
        <View style={styles.container}>
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.filterContainer}>
                    ...
                    <TouchableOpacity
                        style={[styles.filterButton, selectedRole === 'DOCTOR' && styles.filterButtonActive]}
                        onPress={() => setSelectedRole('DOCTOR')}
                    >
                        <Text style={[styles.filterText, selectedRole === 'DOCTOR' && styles.filterTextActive]}>Professors</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
