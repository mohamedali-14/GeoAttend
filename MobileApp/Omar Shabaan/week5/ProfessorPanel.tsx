...
export default function ProfessorDashboard() {
    ...
    const handleCreateSession = async () => {
        ...
        try {
            ...
            const autoStartTime = formatTime(now);
            const autoEndTime = formatTime(endDate);
    ...
    const formatSessionTime = (timeData: any) => {
        ...
        try {
            ...
            if (typeof timeData.toDate === 'function') {
                return timeData.toDate().toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true });
            }

            if (timeData instanceof Date) {
                return timeData.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true });
            }

            if (timeData.seconds) {
                return new Date(timeData.seconds * 1000).toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true });
            }
