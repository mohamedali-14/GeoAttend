...
interface Props {
    ...
    studentId: string;
    studentName: string;
    onScanned: (sessionId: string, courseId: string) => void;
        ...
        <Modal visible={visible} animationType="slide" transparent={false}>
            <View style={styles.root}>
                <View style={styles.header}>
                    ...
                    <TouchableOpacity onPress={() => setFlashEnabled(prev => !prev)} style={styles.flashBtn}>
                        <Icon name={flashEnabled ? "flash-on" : "flash-off"} size={24} color="#fff" />
                    </TouchableOpacity>
                </View>
...
const styles = StyleSheet.create({
    ...
    flashBtn: { width: 40, height: 40, justifyContent: 'center', alignItems: 'center' },
